...
checkpoint = "./checkpoint_flickr30k_5_cap_per_img_5_min_word_freq.pth.tar"  # path to checkpoint, None if none
...
def main():
    ...
    if checkpoint is None:
        ...
        adjust_learning_rate(decoder_optimizer, 1.5625) 
        print("Loading checkpoint and re-starting at epoch",start_epoch)
        ...
        if i % print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'Top-5 Accuracy {top5.val:.3f} ({top5.avg:.3f})'.format(epoch, i, len(train_loader),
                                                                          ...
                                                                          top5=top5accs))
            torch.save(decoder.state_dict(), 'decoder_saved.pth')
